...
function Search(props) {
   ...
   const handleSubmit = () => {
      ...
      if (create_lte) {
         data.create_lte = create_lte.toLocaleDateString();
      }
      if (create_gte) {
         data.create_gte = create_gte.toLocaleDateString();
      }
      if (complete_lte) {
         data.complete_lte = complete_lte.toLocaleDateString();
      }
      if (complete_gte) {
         data.complete_gte = complete_gte.toLocaleDateString();
      }
      if (search) {
         data.search = search;
      }
